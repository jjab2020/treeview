...
class Dependance extends MY_Controller {
	...
	public function index()
	{
        ...
        echo $this->blade->view()->make('membre/dependance_vue', ['users' => $userLists,'typeMembre'=>$typeMembreLists,'preuveRevenu'=>$preuveRevenuLists,'sourceRevenu'=>$sourceRevenuLists,'groupeSpec'=>$groupeSpecLists]);
	}
}