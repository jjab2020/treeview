...
class PlanAction extends MY_Controller {
	...
	public function index()
	{
        ...
        echo $this->blade->view()->make('membre/planAction_vue', ['users' => $userLists,'typeMembre'=>$typeMembreLists,'preuveRevenu'=>$preuveRevenuLists,'sourceRevenu'=>$sourceRevenuLists,'groupeSpec'=>$groupeSpecLists]);
	}
}