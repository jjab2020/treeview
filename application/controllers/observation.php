...
class Observation extends MY_Controller {
	...
	public function index()
	{
        ...
        echo $this->blade->view()->make('membre/observation_vue', ['users' => $userLists,'typeMembre'=>$typeMembreLists,'preuveRevenu'=>$preuveRevenuLists,'sourceRevenu'=>$sourceRevenuLists,'groupeSpec'=>$groupeSpecLists]);
	}
}